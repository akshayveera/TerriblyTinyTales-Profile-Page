...
const Posts = () => {
  ...
  return (
    <div className='mt-10'>
        <div className='flex'>
            <div className='text-blue-500 font-bold text-center border-t-2 border-r-2 rounded-tr-lg w-44 pt-2 pl-1 sm:w-52 sm:pl-7 md:text-xl md:pl-10'>134 Posts</div>
